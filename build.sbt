...
libraryDependencies ++= Seq(
    "net.databinder" %% "unfiltered-filter" % "0.7.1" % "test" withSources(),
    "net.databinder" %% "unfiltered-jetty" % "0.7.1" % "test" withSources(),
    "org.eclipse.jetty.orbit" % "javax.servlet" % "2.5.0.v201103041518" % "test" withSources(),
