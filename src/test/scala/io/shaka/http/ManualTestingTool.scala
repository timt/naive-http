...
object ManualTestingServerTool extends App {
  private val ksConfig = PathAndPassword("src/test/resources/certs/keystore-testing.jks", "password")
  private val tsConfig = PathAndPassword("server-truststore.jks", "password")
