...
object TestCerts {
  ...
  val trustStoreWithClientCert: PathAndPassword = PathAndPassword("server-truststore.jks", "password")
  ...
  // Certificate fingerprint (MD5): 90:75:3A:10:1C:64:18:86:B4:EC:36:2D:40:2F:69:F6
  val trustStoreWithServerCert: PathAndPassword = PathAndPassword("client-truststore.jks", "password")
